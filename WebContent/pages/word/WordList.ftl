					...
					<div class="row-fluid">
					    <div class="ace-thumbnails">
							...
							<button class="btn btn-small btn-primary" onclick="addObj();">
								<i class="icon-plus-sign bigger-125"></i>新建稿件图像
							</button>
						...
						<div class="on-down">
							<form id="form" commandName="form" action="manager" class="form-horizontal"></br>
								<div class="row-fluid">
									<div class="control-group span3">
										<label class="control-label" for="form-field-2">标题：</label>
										<div class="controls">
											<input id="title" class="span10" onkeydown="if (13 == event.keyCode) { $('.btn-success').focus(); }" />
										</div>
									</div>
									
									<div class="control-group span3">
										<label class="control-label" for="form-field-2">稿件名称：</label>
										<div class="controls">
											<input id="name" class="span10" onkeydown="if (13 == event.keyCode) { $('.btn-success').focus(); }" />
										</div>
									</div>
									
									<div class="control-group span3">
										<label class="control-label" for="form-field-2">图片名称：</label>
										<div class="controls">
											<input id="photo" class="span10" onkeydown="if (13 == event.keyCode) { $('.btn-success').focus(); }" />
										</div>
									</div>
								</div></br>
